...
$query = "INSERT INTO entry_data (Brand,Vehicle_type,Model,Budget,Mileage,Engine,Type,Photo)"." values('$brand','$vehicletype','$selectmodel','$selectbudget','$selectmileage','$selectengine','$selecttype','$target_file')";// name' set to UNIQUE 
echo $query;
